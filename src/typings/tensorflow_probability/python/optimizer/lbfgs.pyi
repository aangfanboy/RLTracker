...
def minimize(value_and_gradients_function, initial_position, previous_optimizer_results=..., num_correction_pairs=..., tolerance=..., x_tolerance=..., f_relative_tolerance=..., initial_inverse_hessian_estimate=..., max_iterations=..., parallel_iterations=..., stopping_condition=..., max_line_search_iterations=..., f_absolute_tolerance=..., name=...):
