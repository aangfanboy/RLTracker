...
def hager_zhang(value_and_gradients_function, initial_step_size=..., value_at_initial_step=..., value_at_zero=..., converged=..., threshold_use_approximate_wolfe_condition=..., shrinkage_param=..., expansion_param=..., sufficient_decrease_param=..., curvature_param=..., max_iterations=..., name=...):
