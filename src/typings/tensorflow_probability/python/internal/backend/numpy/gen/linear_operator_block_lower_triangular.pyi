...
class LinearOperatorBlockLowerTriangular(linear_operator.LinearOperator):
  ...
  * If `is_X == None` (the default), callers should have no expectation either
  ...
  def matmul(self, x, adjoint=..., adjoint_arg=..., name=...): # -> LinearOperator | list[Any] | Any:
  ...
  def matvec(self, x, adjoint=..., name=...): # -> list[Any]:
  ...
  def solve(self, rhs, adjoint=..., adjoint_arg=..., name=...): # -> LinearOperator | list[Any] | Any:
  ...
  def solvevec(self, rhs, adjoint=..., name=...): # -> list[Any]:
