...
_FFT_OP = ...
_IFFT_OP = ...
def exponential_power_convolution_kernel(grid_shape, length_scale, power=..., divisor=..., zero_inflation=...): # -> Any:
...
class _BaseLinearOperatorCirculant(linear_operator.LinearOperator):
  ...
  """
  def __init__(self, spectrum: np.ndarray, block_depth: int, input_output_dtype=..., is_non_singular: bool = ..., is_self_adjoint: bool = ..., is_positive_definite: bool = ..., is_square: bool = ..., parameters=..., name=...) -> None:
  ...
  def block_shape_tensor(self): # -> NDArray[signedinteger[_32Bit]] | Any:
  ...
  def convolution_kernel(self, name=...):
  ...
  def assert_hermitian_spectrum(self, name=...): # -> None:
...
class LinearOperatorCirculant(_BaseLinearOperatorCirculant):
  ...
  * If `is_X == None` (the default), callers should have no expectation either
  ...
  """
  def __init__(self, spectrum: np.ndarray, input_output_dtype=..., is_non_singular: bool = ..., is_self_adjoint: bool = ..., is_positive_definite: bool = ..., is_square: bool = ..., name=...) -> None:
