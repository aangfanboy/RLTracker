...
import abc
from tensorflow_probability.python.internal.backend.numpy import composite_tensor, composite_tensor_gradient, deprecation, type_spec
...
class LinearOperator(module.Module, composite_tensor.CompositeTensor, metaclass=abc.ABCMeta):
  ...
  * If `is_X == None` (the default), callers should have no expectation either
  ...
  def shape_tensor(self, name=...): # -> NDArray[signedinteger[_32Bit]]:
  ...
  @property
  def batch_shape(self): # -> TensorShape | Dimension | None:
  ...
  def batch_shape_tensor(self, name=...): # -> NDArray[signedinteger[_32Bit]]:
  ...
  @property
  def tensor_rank(self, name=...): # -> int | None:
  ...
  def tensor_rank_tensor(self, name=...): # -> NDArray[signedinteger[_32Bit]]:
    """Rank (in the sense of tensors) of matrix corresponding to this operator.
  ...
  def domain_dimension_tensor(self, name=...): # -> NDArray[signedinteger[_32Bit]] | Any:
    """Dimension (in the sense of vector spaces) of the domain of this operator.
  ...
  def range_dimension_tensor(self, name=...): # -> NDArray[signedinteger[_32Bit]] | Any:
    """Dimension (in the sense of vector spaces) of the range of this operator.
  ...
  def matvec(self, x, adjoint=..., name=...):
  ...
  def solve(self, rhs, adjoint=..., adjoint_arg=..., name=...): # -> LinearOperator | Any | ndarray[_Shape, dtype[Any]] | NDArray[Any] | ndarray[_Shape, dtype[float64]]:
  ...
  def solvevec(self, rhs, adjoint=..., name=...):
  ...
  def diag_part(self, name=...): # -> NDArray[Any]:
