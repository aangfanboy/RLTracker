...
def convert_nonref_to_tensor(value, dtype=..., dtype_hint=..., name=...): # -> None:
...
def assert_no_entries_with_modulus_zero(x, message=..., name=...): # -> None:
...
def assert_zero_imag_part(x, message=..., name=...): # -> None:
...
def assert_compatible_matrix_dimensions(operator, x): # -> None:
...
def matrix_solve_with_broadcast(matrix, rhs, adjoint=..., name=...): # -> NDArray[Any] | ndarray[_Shape, dtype[float64]]:
...
def split_arg_into_blocks(block_dims, block_dims_fn, arg, axis=...): # -> list[NDArray[Any]]:
...
JAX_MODE = ...
if JAX_MODE:
  def shape_tensor(shape, name=...): # -> NDArray[signedinteger[_32Bit]]:
    ...
