...
__all__ = ['BatchedComponentProperties', 'BIJECTOR_NOT_IMPLEMENTED', 'ParameterProperties', 'SHAPE_FN_NOT_IMPLEMENTED']
NO_EVENT_NDIMS = ...
def BIJECTOR_NOT_IMPLEMENTED():
  ...

def SHAPE_FN_NOT_IMPLEMENTED(sample_shape):
  ...

class ParameterProperties(collections.namedtuple('ParameterProperties', ['event_ndims', 'event_ndims_tensor', 'shape_fn', 'default_constraining_bijector_fn', 'is_preferred', 'is_tensor', 'specifies_shape'])):
  ...
  **In general, default constraining bijectors should attempt to
  ...
  __slots__ = ...
  NO_EVENT_NDIMS = ...
  def __new__(cls, event_ndims=..., event_ndims_tensor=..., shape_fn=..., default_constraining_bijector_fn=..., is_preferred=..., is_tensor=..., specifies_shape=...): # -> Self:
    ...
  
  def instance_event_ndims(self, instance, require_static=...): # -> object:
    ...
  
  def bijector_instance_event_ndims(self, bijector, x_event_ndims, require_static=...): # -> object | None:
...
class BatchedComponentProperties(ParameterProperties):
  ...
  def __new__(cls, event_ndims=..., event_ndims_tensor=..., default_constraining_bijector_fn=..., is_preferred=...): # -> Self:
    ...
...
class ShapeParameterProperties(ParameterProperties):
  ...
  def __new__(cls, is_preferred=...): # -> Self:
    ...
