...
"""SoftClip bijector."""
__all__ = ['SoftClip']
class SoftClip(bijector.CoordinatewiseBijectorMixin, bijector.AutoCompositeTensorBijector):
  ...
  """
  def __init__(self, low=..., high=..., hinge_softness=..., validate_args=..., name=...) -> None:
