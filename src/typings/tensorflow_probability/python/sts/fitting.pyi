...
@deprecation.deprecated('2022-03-01', 'Please use `tf.random.stateless_uniform` or similar.')
def sample_uniform_initial_state(parameter, return_constrained=..., init_sample_shape=..., seed=...):
...
def build_factored_surrogate_posterior(model, batch_shape=..., seed=..., name=...):
...
def build_factored_surrogate_posterior_stateless(model, batch_shape=..., name=...):
...
def fit_with_hmc(model, observed_time_series, num_results=..., num_warmup_steps=..., num_leapfrog_steps=..., initial_state=..., initial_step_size=..., chain_batch_shape=..., num_variational_steps=..., variational_optimizer=..., variational_sample_size=..., seed=..., name=...): # -> tuple[Any, Any]:
