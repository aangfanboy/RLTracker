...
def decompose_by_component(model, observed_time_series, parameter_samples): # -> OrderedDict[Any, Any]:
...
def decompose_forecast_by_component(model, forecast_dist, parameter_samples): # -> OrderedDict[Any, Any]:
