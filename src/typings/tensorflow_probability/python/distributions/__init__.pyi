...
from tensorflow_probability.python.distributions.deterministic import Deterministic, VectorDeterministic
from tensorflow_probability.python.distributions.dirichlet import Dirichlet, FlatDirichlet
from tensorflow_probability.python.distributions.dirichlet_multinomial import DirichletMultinomial
from tensorflow_probability.python.distributions.distribution import AutoCompositeTensorDistribution, Distribution
...
from tensorflow_probability.python.distributions.exp_gamma import ExpGamma, ExpInverseGamma
...
from tensorflow_probability.python.distributions.inflated import Inflated, ZeroInflatedNegativeBinomial
...
from tensorflow_probability.python.distributions.joint_distribution_auto_batched import JointDistributionCoroutineAutoBatched, JointDistributionNamedAutoBatched, JointDistributionSequentialAutoBatched
...
from tensorflow_probability.python.distributions.lambertw_f import LambertWDistribution, LambertWNormal
...
from tensorflow_probability.python.distributions.poisson_lognormal import PoissonLogNormalQuadratureCompound, quadrature_scheme_lognormal_gauss_hermite, quadrature_scheme_lognormal_quantiles
...
from tensorflow_probability.python.distributions.relaxed_onehot_categorical import ExpRelaxedOneHotCategorical, RelaxedOneHotCategorical
...
from tensorflow_probability.python.distributions.wishart import WishartLinearOperator, WishartTriL
...
from tensorflow_probability.python.distributions.kullback_leibler import RegisterKL, augment_kl_xent_docs, kl_divergence
from tensorflow_probability.python.distributions.normal_conjugate_posteriors import mvn_conjugate_linear_update, normal_conjugates_known_scale_posterior, normal_conjugates_known_scale_predictive
from tensorflow_probability.python.internal.reparameterization import FULLY_REPARAMETERIZED, NOT_REPARAMETERIZED, ReparameterizationType
from tensorflow.python.util import deprecation

"""Statistical distributions."""
__all__ = ['Autoregressive', 'AutoCompositeTensorDistribution', 'BatchBroadcast', 'BatchReshape', 'Bates', 'Bernoulli', 'Beta', 'BetaBinomial', 'BetaQuotient', 'Binomial', 'Blockwise', 'Categorical', 'Cauchy', 'Chi', 'Chi2', 'CholeskyLKJ', 'DeterminantalPointProcess', 'Deterministic', 'Dirichlet', 'DirichletMultinomial', 'Distribution', 'DoublesidedMaxwell', 'Empirical', 'ExpGamma', 'ExpInverseGamma', 'Exponential', 'ExponentiallyModifiedGaussian', 'ExpRelaxedOneHotCategorical', 'FiniteDiscrete', 'FlatDirichlet', 'FULLY_REPARAMETERIZED', 'Gamma', 'GammaGamma', 'GaussianProcess', 'GaussianProcessRegressionModel', 'GeneralizedExtremeValue', 'GeneralizedNormal', 'GeneralizedPareto', 'Geometric', 'Gumbel', 'HalfCauchy', 'HalfNormal', 'HalfStudentT', 'HiddenMarkovModel', 'Horseshoe', 'Independent', 'independent_joint_distribution_from_structure', 'Inflated', 'InverseGamma', 'InverseGaussian', 'JohnsonSU', 'JointDistribution', 'JointDistributionCoroutine', 'JointDistributionCoroutineAutoBatched', 'JointDistributionNamed', 'JointDistributionNamedAutoBatched', 'JointDistributionSequential', 'JointDistributionSequentialAutoBatched', 'kl_divergence', 'Kumaraswamy', 'LambertWDistribution', 'LambertWNormal', 'Laplace', 'LinearGaussianStateSpaceModel', 'LKJ', 'Logistic', 'LogitNormal', 'LogLogistic', 'LogNormal', 'MarkovChain', 'Masked', 'MatrixNormalLinearOperator', 'MatrixTLinearOperator', 'Mixture', 'MixtureSameFamily', 'Moyal', 'Multinomial', 'MultivariateNormalDiag', 'MultivariateNormalDiagPlusLowRank', 'MultivariateNormalDiagPlusLowRankCovariance', 'MultivariateNormalFullCovariance', 'MultivariateNormalLinearOperator', 'MultivariateNormalTriL', 'MultivariateStudentTLinearOperator', 'mvn_conjugate_linear_update', 'NegativeBinomial', 'NoncentralChi2', 'Normal', 'normal_conjugates_known_scale_posterior', 'normal_conjugates_known_scale_predictive', 'NormalInverseGaussian', 'NOT_REPARAMETERIZED', 'OneHotCategorical', 'OrderedLogistic', 'Pareto', 'PERT', 'PixelCNN', 'PlackettLuce', 'Poisson', 'PoissonLogNormalQuadratureCompound', 'PowerSpherical', 'ProbitBernoulli', 'quadrature_scheme_lognormal_gauss_hermite', 'quadrature_scheme_lognormal_quantiles', 'QuantizedDistribution', 'RegisterKL', 'RelaxedBernoulli', 'RelaxedOneHotCategorical', 'ReparameterizationType', 'Sample', 'SigmoidBeta', 'SinhArcsinh', 'Skellam', 'SphericalUniform', 'StoppingRatioLogistic', 'StudentT', 'StudentTProcess', 'StudentTProcessRegressionModel', 'TransformedDistribution', 'Triangular', 'TruncatedCauchy', 'TruncatedNormal', 'TwoPieceNormal', 'TwoPieceStudentT', 'Uniform', 'VariationalGaussianProcess', 'VectorDeterministic', 'VonMises', 'VonMisesFisher', 'Weibull', 'WishartLinearOperator', 'WishartTriL', 'ZeroInflatedNegativeBinomial', 'Zipf']
