...
from tensorflow_probability.python.distributions import joint_distribution_coroutine, joint_distribution_named, joint_distribution_sequential
from tensorflow_probability.python.internal import auto_composite_tensor

"""Joint distributions with inferred batch semantics."""
JAX_MODE = ...
class JointDistributionCoroutineAutoBatched(joint_distribution_coroutine.JointDistributionCoroutine):
  ...
  """
  def __init__(self, model, sample_dtype=..., batch_ndims=..., use_vectorized_map=..., validate_args=..., experimental_use_kahan_sum=..., name=...) -> None:
...
class _JointDistributionNamedAutoBatched(joint_distribution_named._JointDistributionNamed):
...
class _JointDistributionSequentialAutoBatched(joint_distribution_sequential._JointDistributionSequential):
...
class JointDistributionSequentialAutoBatched(_JointDistributionSequentialAutoBatched, tf.__internal__.CompositeTensor):
  def __new__(cls, *args, **kwargs): # -> _JointDistributionSequentialAutoBatched:
    """Maybe returns a `_JointDistributionSequentialAutobatched`."""
    ...
  


@auto_composite_tensor.type_spec_register('tfp.distributions.JointDistributionSequentialAutoBatchedSpec')
class _JointDistributionSequentialAutoBatchedSpec(joint_distribution_sequential._JointDistributionSequentialSpec):
  """Type spec for `JointDistributionSequentialAutoBatched`."""
  @property
  def value_type(self): # -> type[JointDistributionSequentialAutoBatched]:
    ...
  


class JointDistributionNamedAutoBatched(_JointDistributionNamedAutoBatched, tf.__internal__.CompositeTensor):
  def __new__(cls, *args, **kwargs): # -> _JointDistributionNamedAutoBatched:
    """Maybe returns a `_JointDistributionNamedAutoBatched`."""
    ...
  


@auto_composite_tensor.type_spec_register('tfp.distributions.JointDistributionNamedAutoBatchedSpec')
class _JointDistributionNamedAutoBatchedSpec(joint_distribution_named._JointDistributionNamedSpec):
  """Type spec for `JointDistributionNamedAutoBatched`."""
  @property
  def value_type(self): # -> type[JointDistributionNamedAutoBatched]:
    ...
