...
from tensorflow_probability.python.distributions import distribution as distribution_lib, joint_distribution as joint_distribution_lib

"""The `JointDistributionCoroutine` class."""
__all__ = ['JointDistributionCoroutine']
JAX_MODE = ...
class JointDistributionCoroutine(joint_distribution_lib.JointDistribution, distribution_lib.AutoCompositeTensorDistribution):
