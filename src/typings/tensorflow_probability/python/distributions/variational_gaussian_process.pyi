...
__all__ = ['VariationalGaussianProcess']
class _VariationalKernel(psd_kernel.AutoCompositeTensorPsdKernel):
  ...
  """
  def __init__(self, base_kernel, inducing_index_points, variational_scale, cholesky_fn=..., use_whitening_transform=..., jitter=..., name=...) -> None:
  ...
  @property
  def use_whitening_transform(self): # -> bool:
    ...
...
class VariationalGaussianProcess(gaussian_process.GaussianProcess, distribution.AutoCompositeTensorDistribution):
  ...
  ***The approximate posterior predictive distribution `q(f(T))` is what the
  ...
  """
  def __init__(self, kernel, index_points, inducing_index_points, variational_inducing_observations_loc, variational_inducing_observations_scale, mean_fn=..., observation_noise_variance=..., predictive_noise_variance=..., cholesky_fn=..., use_whitening_transform=..., jitter=..., validate_args=..., allow_nan_stats=..., name=...) -> None:
  ...
  def surrogate_posterior_expected_log_likelihood(self, observations, observation_index_points=..., log_likelihood_fn=..., quadrature_size=..., name=...):
  ...
  def surrogate_posterior_kl_divergence_prior(self, name=...):
  ...
  def variational_loss(self, observations, observation_index_points=..., log_likelihood_fn=..., quadrature_size=..., kl_weight=..., name=...):
  ...
  @staticmethod
  def optimal_variational_posterior(kernel, inducing_index_points, observation_index_points, observations, observation_noise_variance, mean_fn=..., cholesky_fn=..., jitter=..., name=...): # -> tuple[Any, Any]:
