...
_DIVERGENCES = ...
__all__ = ["RegisterKL", "kl_divergence", "augment_kl_xent_docs"]
def kl_divergence(distribution_a, distribution_b, allow_nan_stats=..., name=...):
...
def augment_kl_xent_docs(distributions_module): # -> None:
