...
information matrix.
"""
__all__ = ['fit_sparse', 'fit_sparse_one_step']
def fit_sparse_one_step(model_matrix, response, model, model_coefficients_start, tolerance, l1_regularizer, l2_regularizer=..., maximum_full_sweeps=..., learning_rate=..., name=...):
...
def fit_sparse(model_matrix, response, model, model_coefficients_start, tolerance, l1_regularizer, l2_regularizer=..., maximum_iterations=..., maximum_full_sweeps_per_iteration=..., learning_rate=..., name=...):
