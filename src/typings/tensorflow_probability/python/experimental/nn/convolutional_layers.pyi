...
__all__ = ['Convolution', 'ConvolutionVariationalFlipout', 'ConvolutionVariationalReparameterization']
...
class Convolution(layers_lib.KernelBiasLayer):
  ...
  """
  def __init__(self, input_size, output_size, filter_shape, rank=..., strides=..., padding=..., dilations=..., kernel_initializer=..., bias_initializer=..., make_kernel_bias_fn=..., dtype=..., batch_shape=..., activation_fn=..., validate_args=..., name=...) -> None:
    """Constructs layer.
...
class ConvolutionVariationalReparameterization(vi_lib.VariationalReparameterizationKernelBiasLayer):
  ...
  """
  def __init__(self, input_size, output_size, filter_shape, rank=..., strides=..., padding=..., dilations=..., kernel_initializer=..., bias_initializer=..., make_posterior_fn=..., make_prior_fn=..., posterior_value_fn=..., unpack_weights_fn=..., dtype=..., activation_fn=..., seed=..., validate_args=..., name=...) -> None:
    """Constructs layer.
...
def prepare_strides(x, n, arg_name): # -> tuple[Any, ...]:
  """Mimics prepare_tuple_argument, but puts a 1 for the 0th and 3rd element."""
  ...

def convolution_batch(x, kernel, rank, strides, padding, data_format=..., dilations=..., name=...):
