...
from tensorflow_probability.python.experimental.nn import layers as layers_lib, variational_base as vi_lib

"""ConvolutionTranspose layers for building neural networks."""
__all__ = ['ConvolutionTranspose', 'ConvolutionTransposeVariationalFlipout', 'ConvolutionTransposeVariationalReparameterization']
tfd = distribution_lib
unpack_kernel_and_bias = ...
class ConvolutionTranspose(layers_lib.KernelBiasLayer):
  ...
  """
  def __init__(self, input_size, output_size, filter_shape, rank=..., strides=..., padding=..., dilations=..., output_padding=..., method=..., kernel_initializer=..., bias_initializer=..., make_kernel_bias_fn=..., dtype=..., index_dtype=..., activation_fn=..., validate_args=..., name=...) -> None:
    """Constructs layer.
...
class ConvolutionTransposeVariationalReparameterization(vi_lib.VariationalReparameterizationKernelBiasLayer):
  ...
  """
  def __init__(self, input_size, output_size, filter_shape, rank=..., strides=..., padding=..., dilations=..., output_padding=..., method=..., kernel_initializer=..., bias_initializer=..., make_posterior_fn=..., make_prior_fn=..., posterior_value_fn=..., unpack_weights_fn=..., dtype=..., index_dtype=..., activation_fn=..., seed=..., validate_args=..., name=...) -> None:
    """Constructs layer.
...
class ConvolutionTransposeVariationalFlipout(vi_lib.VariationalFlipoutKernelBiasLayer):
