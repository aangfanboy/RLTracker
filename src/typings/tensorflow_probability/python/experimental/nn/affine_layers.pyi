...
__all__ = ['Affine', 'AffineVariationalFlipout', 'AffineVariationalReparameterization', 'AffineVariationalReparameterizationLocal']
tfd = distribution_lib
unpack_kernel_and_bias = ...
class Affine(layers_lib.KernelBiasLayer):
  """Basic affine layer."""
  def __init__(self, input_size, output_size, kernel_initializer=..., bias_initializer=..., make_kernel_bias_fn=..., dtype=..., batch_shape=..., activation_fn=..., name=...) -> None:
    """Constructs layer.
...
class AffineVariationalReparameterization(vi_lib.VariationalReparameterizationKernelBiasLayer):
  ...
  """
  def __init__(self, input_size, output_size, kernel_initializer=..., bias_initializer=..., make_posterior_fn=..., make_prior_fn=..., posterior_value_fn=..., unpack_weights_fn=..., dtype=..., activation_fn=..., seed=..., validate_args=..., name=...) -> None:
    """Constructs layer.
