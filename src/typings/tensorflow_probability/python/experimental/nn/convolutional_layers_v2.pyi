...
__all__ = ['ConvolutionV2', 'ConvolutionVariationalFlipoutV2', 'ConvolutionVariationalReparameterizationV2']
...
class ConvolutionV2(layers_lib.KernelBiasLayer):
  ...
  """
  def __init__(self, input_size, output_size, filter_shape, rank=..., strides=..., padding=..., dilations=..., kernel_initializer=..., bias_initializer=..., make_kernel_bias_fn=..., dtype=..., index_dtype=..., batch_shape=..., activation_fn=..., validate_args=..., name=...) -> None:
    """Constructs layer.
...
class ConvolutionVariationalReparameterizationV2(vi_lib.VariationalReparameterizationKernelBiasLayer):
  ...
  """
  def __init__(self, input_size, output_size, filter_shape, rank=..., strides=..., padding=..., dilations=..., kernel_initializer=..., bias_initializer=..., make_posterior_fn=..., make_prior_fn=..., posterior_value_fn=..., unpack_weights_fn=..., dtype=..., index_dtype=..., activation_fn=..., seed=..., validate_args=..., name=...) -> None:
    """Constructs layer.
