...
__all__ = ['StateWithHistory', 'augment_with_observation_history', 'augment_with_state_history', 'augment_prior_with_state_history']
StateWithHistory = ...
def augment_with_observation_history(observations, history_size, num_transitions_per_observation=...): # -> Callable[..., Callable[..., Any]]:
...
def augment_with_state_history(fn): # -> Callable[..., JointDistributionNamed]:
...
def augment_prior_with_state_history(prior, history_size): # -> JointDistributionNamed:
