...
__all__ = ['sample_annealed_importance_chain']
class AISResults(mcmc_util.PrettyNamedTupleMixin, collections.namedtuple('AISResults', ['proposal_log_prob', 'target_log_prob', 'inner_results'])):
  __slots__ = ...


def sample_annealed_importance_chain(num_steps, proposal_log_prob_fn, target_log_prob_fn, current_state, make_kernel_fn, parallel_iterations=..., seed=..., name=...): # -> list[Any]:
