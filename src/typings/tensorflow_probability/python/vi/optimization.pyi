...
_trace_loss = ...
def fit_surrogate_posterior_stateless(target_log_prob_fn, build_surrogate_posterior_fn, initial_parameters, optimizer, num_steps, convergence_criterion=..., trace_fn=..., discrepancy_fn=..., sample_size=..., importance_sample_size=..., gradient_estimator=..., jit_compile=..., seed=..., name=...): # -> tuple[Any, Any]:
...
def fit_surrogate_posterior(target_log_prob_fn, surrogate_posterior, optimizer, num_steps, convergence_criterion=..., trace_fn=..., discrepancy_fn=..., sample_size=..., importance_sample_size=..., trainable_variables=..., jit_compile=..., seed=..., name=...):
  """Fit a surrogate posterior to a target (unnormalized) log density.
